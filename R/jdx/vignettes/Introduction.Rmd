...
The functionality of jdx is similar to the [jsonlite](https://cran.r-project.org/package=jsonlite) package. In contrast to jsonlite, jdx is designed specifically for the Java platform, it provides exact precision for numeric values (because it doesn't convert numbers to text), and it requires less overhead.
