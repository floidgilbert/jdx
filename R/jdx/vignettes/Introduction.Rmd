...
### R Matrices and N-dimensional Arrays
...
The jdx package supports data exchange for lists, named lists, nested lists (lists containing other lists), and environments. The `convertToJava()` function converts R lists to Java `ArrayList<Object>` objects. It converts named lists and `environment` objects to Java `LinkedHashMap<String, Object>` objects.

## Converting Java Objects to R Objects

///talk about how supporting collection and maps gets us everything. Primitives, boxed, and BigInt...

### Java Scalars

### Java One-dimensional Arrays

### Java N-dimensional Rectangular Arrays

### Java Ragged Arrays

### Java Maps (java.util.Map Interface)

### Java Collections (java.util.Collection)
