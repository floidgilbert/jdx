...
**IMPORTANT:** The `convertToR()` function is not thread-safe. Do not simultaneously call `convertToR()` from different threads in the same process. See the R documentation for `convertToRlowLevel()` for a thread-safe alternative.
