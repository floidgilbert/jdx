...
for (i in 0:5) {
  for (j in 0:5) {
    ...
    expect_identical(s1, s2)
    if (i == 0) {
      expect_identical(convertToR(o, array.order = "row-major-java"), array(character(0), c(0, 0)))
    } else {
...
for (i in 0:5) {
  for (j in 0:5) {
    for (k in 0:5) {
      ...
      expect_identical(s1, s2)
      if (k == 0) {
        expect_identical(convertToR(o, array.order = "row-major-java"), array(character(0), c(0, 0, 0)))
      } else if (k > 0 & i == 0) {
        expect_identical(convertToR(o, array.order = "row-major-java"), array(character(0), c(0, 0, k)))
      } else {
        expect_identical(convertToR(o, array.order = "row-major-java"), a)
      }
    }
...
a <- array("a", c(0, 1, 1, 1))
expect_identical(convertToR(convertToJava(a, array.order = "row-major-java"), array.order = "row-major-java"), array("a", c(0, 0, 1, 1)))
a <- array("a", c(1, 1, 0, 1))
expect_identical(convertToR(convertToJava(a, array.order = "row-major-java"), array.order = "row-major-java"), array("a", c(0, 0, 0, 1)))
a <- array("a", c(1, 0, 0, 1))
expect_identical(convertToR(convertToJava(a, array.order = "row-major-java"), array.order = "row-major-java"), array("a", c(0, 0, 0, 1)))
a <- array("a", c(1, 0, 1, 1))
expect_identical(convertToR(convertToJava(a, array.order = "row-major-java"), array.order = "row-major-java"), array("a", c(1, 0, 1, 1)))
...
expect_identical(convertToR(convertToJava(a, array.order = "row-major-java"), array.order = "row-major-java"), a)
a <- array("a", c(0, 1, 1, 1, 1))
expect_identical(convertToR(convertToJava(a, array.order = "row-major-java"), array.order = "row-major-java"), array("a", c(0, 0, 1, 1, 1)))
a <- array("a", c(0, 1, 1, 0, 1))
expect_identical(convertToR(convertToJava(a, array.order = "row-major-java"), array.order = "row-major-java"), array("a", c(0, 0, 0, 0, 1)))
a <- array("a", c(0, 1, 0, 0, 1))
expect_identical(convertToR(convertToJava(a, array.order = "row-major-java"), array.order = "row-major-java"), array("a", c(0, 0, 0, 0, 1)))
a <- array("a", c(0, 1, 0, 1, 1))
expect_identical(convertToR(convertToJava(a, array.order = "row-major-java"), array.order = "row-major-java"), array("a", c(0, 0, 0, 1, 1)))
